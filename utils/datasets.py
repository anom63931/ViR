...
if __name__ == '__main__':
    ...
    args.data = '/home/avahdat/data/datasets/imagenet_lmdb/' #' --root /tmp/darts/ --batch_size=24 --dataset imagenet --init_epochs 1 --epochs 100 --arch_learning_rate 1e-3 --report_freq 50 --target_latency 7.5 --meta_loss rebar
